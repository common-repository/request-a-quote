	...
	class EMD_MB_File_Advanced_Field extends EMD_MB_File_Field
	{
		...
		static function admin_enqueue_scripts()
		{
			...
			wp_localize_script( 'emd-mb-file-advanced', 'emdmbFileAdvanced', array(
				'frameTitle' => __( 'Select Files', 'request-a-quote' ),
			) );
		}
		...
		{
			$i18n_title  = apply_filters( 'emd_mb_file_advanced_select_string', _x( 'Select or Upload Files', 'file upload', 'request-a-quote' ), $field );
            ...
            <script id="tmpl-emd-mb-file-advanced" type="text/html">
				...
				<li>
					...
					<div class="emd-mb-info">
						...
						<a title="<?php echo esc_attr($i18n_delete); ?>" class="emd-mb-delete-file" href="#" data-attachment_id="{{{ attachment.id }}}"><?php echo esc_html($i18n_delete); ?></a>
					</div>
				</li>
				<# } ); #>
			</script>
