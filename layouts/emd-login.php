...
<fieldset>
<legend><?php esc_html_e( 'Log into Your Account', 'request-a-quote' ); ?></legend>
...
<label for="emd_user_login"><span><?php esc_html_e( 'Username or Email', 'request-a-quote' ); ?></span>
<span class="emd-fieldicons-wrap">
<a href="#" data-html="true" tabindex=-1 data-toggle="tooltip" title="<?php esc_html_e('Username or Email field is required','request-a-quote');?>" id="req_user_login" class="helptip">
...
<label for="emd_user_pass"><span><?php esc_html_e( 'Password', 'request-a-quote' ); ?></span>
<span class="emd-fieldicons-wrap">
<a href="#" data-html="true" tabindex=-1 data-toggle="tooltip" title="<?php esc_html_e('Password field is required','request-a-quote');?>" id="req_user_pass" class="helptip">
...
<label><input name="rememberme" type="checkbox" id="rememberme" value="forever" /> <?php esc_html_e( 'Remember Me', 'request-a-quote' ); ?></label>
</div>
<div>
...
<input type="submit" class="emd_submit button" id="emd-login-submit" value="<?php esc_html_e( 'Log In', 'request-a-quote' ); ?>"/>
</div>
<div style="clear:both">
<p class="emd-lost-password" style="float:left">
<a href="<?php echo wp_lostpassword_url(); ?>">
<?php esc_html_e( 'Lost Password?', 'request-a-quote' ); ?>
</a>
</p>
<p class="emd-register-link" style="float:right">
<a href="">
<?php esc_html_e( 'Register', 'request-a-quote' ); ?>
</a>
</p>
</div>
